...
if ($controller->getAction() == 'inspect') {
            ...
            <div class="float-right">
                ...
                if ($u->isSuperUser()) {
                    ...
                    <a href="javascript:void(0)" class="btn btn-danger"
                       onclick="removeBlockType()"><?= t('Remove') ?></a>
                    <script>
    ...
    <ul class="item-select-list" id="ccm-btlist-btsets">
        ...
        foreach ($normalBlockTypesAndSets as $normalBlockTypesAndSet) {
            ...
            ?>
            <li class="ccm-btlist-btset"
                data-btset-id="<?= $blockTypeSet === null ? '0' : $blockTypeSet->getBlockTypeSetID() ?>">
    ...
    <ul class="item-select-list">
        ...
        foreach ($internalBlockTypes as $bt) {
            ...
            ?>
            <li>
                <a href="<?= $view->action('inspect', $bt->getBlockTypeID()) ?>"><img
                            src="<?= $btIcon ?>"/> <?= t($bt->getBlockTypeName()) ?></a>
            </li>
            <?php
        }
        ?>
